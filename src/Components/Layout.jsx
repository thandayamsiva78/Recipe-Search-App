...
function Layout() {
    ...
    const [favoriteSelectd, setFavoriteSelected] = useState(false);


    const [count, setCount] = useState(0)
    useEffect(() => {
        const favoritesCount = JSON.parse(localStorage.getItem("Favorites Lists"))
        setCount(favoritesCount.length)
    }, [search])
    ...
    return (
        <>
            <section id="layout">
                ...
                <div className="searchContainer flex flex-col justify-center items-center">
                    <div>
                        <h1 className="text-head font-bold text-4xl text-white pb-10">Whats Your Favorite Recipe ..?</h1>
                    </div>
                ...
                {input === "" ?
                    ...
                    <article className="result-recipes">
                        <h1 className="font-bold pl-6 text-md mt-10">Results...</h1>
